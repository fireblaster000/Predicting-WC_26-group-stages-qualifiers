...
# change these if you move your Excel file or if the sheet name is different. The script will read tournament_year, group_id, team_name, tournament_start_date columns, and write opponent/group Elo features.
