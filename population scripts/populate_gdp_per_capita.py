...
# change these if you move your Excel file or if the sheet name is different. The script will read the tournament_year and team_name columns, and write gdp_per_capita_pre and log_gdp_per_capita_pre columns.
